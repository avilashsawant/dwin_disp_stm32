...
/* USER CODE BEGIN PFP */
void AL_PP_Initialization(void);


void AL_PP_Manual_mode_func(void);
/* USER CODE END PFP */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, led_output_Pin|Buzzer_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, En_A1_Pin|EN_A2_Pin|EN_A3_Pin|EN_A4_Pin
                          |EN_A5_Pin|EN_A6_Pin|EN_A7_Pin|EN_A8_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, SOL_1_Pin|SOL_2_Pin|SOL_3_Pin|SOL_4_Pin
                          |SOL_5_Pin|SOL_6_Pin|SOL_7_Pin|SOL_8_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OE_A_GPIO_Port, OE_A_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, H_F_B_Pin|Stepper_dir_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : led_output_Pin Buzzer_Pin */
  GPIO_InitStruct.Pin = led_output_Pin|Buzzer_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : En_A1_Pin EN_A2_Pin EN_A3_Pin EN_A4_Pin
                           EN_A5_Pin EN_A6_Pin EN_A7_Pin EN_A8_Pin */
  GPIO_InitStruct.Pin = En_A1_Pin|EN_A2_Pin|EN_A3_Pin|EN_A4_Pin
                          |EN_A5_Pin|EN_A6_Pin|EN_A7_Pin|EN_A8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : SOL_1_Pin SOL_2_Pin SOL_3_Pin SOL_4_Pin
                           SOL_5_Pin SOL_6_Pin SOL_7_Pin SOL_8_Pin */
  GPIO_InitStruct.Pin = SOL_1_Pin|SOL_2_Pin|SOL_3_Pin|SOL_4_Pin
                          |SOL_5_Pin|SOL_6_Pin|SOL_7_Pin|SOL_8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : OE_A_Pin */
  GPIO_InitStruct.Pin = OE_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OE_A_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : H_F_B_Pin Stepper_dir_Pin */
  GPIO_InitStruct.Pin = H_F_B_Pin|Stepper_dir_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void AL_PP_Initialization(void)
{
	 ...
	 // disable all motors
	  ...
	  // display logo
	  AL_PP_Disp_Startup();
	  // load by default values in vp
      AL_PP_Disp_Default_Val();
	  // clear flags
      AL_DWIN_Picshow(10);
	  // set motor in home positions
	  AL_PP_Park();

	  // pump read in manual mode screen
	  AL_DWIN_Picshow(100);
	  HAL_Delay(4000);
	  AL_DWIN_Picshow(11);
